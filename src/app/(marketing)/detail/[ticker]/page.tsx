import KpiCard from '@/app/(marketing)/detail/[ticker]/_components/KpiCard'
import Radar from '@/app/(marketing)/detail/[ticker]/_components/Radar'
import Table from '@/app/(marketing)/detail/[ticker]/_components/Table'
