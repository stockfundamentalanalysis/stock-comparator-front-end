...
>(function Toast({ onClose, text }, forwardedRef) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between overflow-hidden whitespace-nowrap rounded-md border border-gray-700 bg-gray-800 text-sm text-white shadow-sm backdrop-blur">
          <RadixToast.Description className="truncate p-4">
            {text}
          </RadixToast.Description>
          <RadixToast.Close className="border-l border-gray-700 p-4 text-gray-500 transition hover:bg-gray-600/30 hover:text-gray-300 active:text-white">
